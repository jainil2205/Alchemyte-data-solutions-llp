        ...
        <>
            <div className="relative w-full">
                ...
                <div className="relative flex items-center justify-center h-60 bg-gray-100">
                    <h1 className="text-[34px] font-bold text-[#2E3E65] text-center font-poppins">Data & AI Strategy</h1>
                </div>
                <div
            ...
            <div className="bg-white min-h-[20vh] px-4 py-6 md:py-10">
                <div className="max-w-7xl mx-auto px-4 lg:px-20">
                    <p className="text-[11px] text-[#2E3E65] pt-5 text-center md:text-left font-poppins">
                        Transform your organization with strategic data and AI services tailored for leadership excellence:
                    </p>

                    <div className="mt-8 text-left">
                        <h2 className="text-[11px] font-semibold text-[#2E3E65] font-poppins">Data and AI Ecosystem Assessment</h2>
                        <p className="text-[11px] text-[#2E3E65] mt-2 font-poppins">
                        ...
                        <h2 className="text-[11px] font-semibold text-[#2E3E65] mt-6 font-poppins">AI-Driven Decision Frameworks</h2>
                        <p className="text-[11px] text-[#2E3E65] mt-2 font-poppins">
                        ...
                        <h2 className="text-[11px] font-semibold text-[#2E3E65] mt-6 font-poppins">Predictive Business Insights</h2>
                        <p className="text-[11px] text-[#2E3E65] mt-2 font-poppins">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-center mt-8 space-y-4 md:space-y-0">
                        ...
                        <button 
                            className="bg-[#2E3E65] text-white px-6 py-3 rounded-md text-[11px] font-bold w-full md:w-auto font-poppins"
