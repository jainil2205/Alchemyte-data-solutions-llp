              ...
              <div className="relative" ref={povDropdownRef}>
                ...
                {openDropdown === "pov" && (
                  <div className="mt-2 md:absolute md:left-0 w-full md:w-36 bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="py-1">
                      <DropdownLink to="" onClick={closeMenu}>Analytics POV</DropdownLink>
                      <DropdownLink to="" onClick={closeMenu}>Product Thinking POV</DropdownLink>
                      <DropdownLink to="" onClick={closeMenu}>Leadership POV</DropdownLink>
                      <DropdownLink to="" onClick={closeMenu}>Agent AI POV</DropdownLink>
                    </div>
                  </div>
                )}
              </div>
