        ...
        <>
            ...
            <div className="relative w-full">
                ...
                <div className="relative w-full h-60 flex items-center justify-center">
                    <h1 className="text-[34px] font-bold text-[#2E3E65] text-center font-poppins opacity-70">Contact Us</h1>
                </div>
            ...
            <div className="bg-white py-6 lg:py-12 px-4 md:px-10 text-[12px] font-poppins">
                <div id="contact" className="flex flex-col lg:flex-row justify-center items-center w-full gap-9">
                    ...
                    <div className="w-full lg:w-2/5 px-6 py-6 bg-white rounded-2xl shadow-lg text-[#2E3E65] border border-gray-200">
                        <div className="mb-4">
                            ...
                            <p className="text-gray-600">innovation@alchemytedata.com</p>
                        </div>
                        <div className="mb-4">
